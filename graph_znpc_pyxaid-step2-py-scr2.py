...
out2inp.out2inp("gznpcsmallo3dftu1.60r.3k.dyn.out","x0.scf.in","wd","x0.scf",0,tot_nsteps,1)  # neutral setup
...
os.chdir("wd")
distribute.distribute(0,tot_nsteps,nsteps_per_job,"submit_templ.pbs",["x0.exp.in"],["x0.scf"],0) # 1 = PBS, 2 = SLURM, 0 = no run
