...
params["active_space"] = [14,15,16,17,18,19,20,21,22]
print "active sapce defined"
# Generate basis states
params["states"] = []
params["states"].append(["GS",[14,-14,15,-15,16,-16]])  # index 0 - ground state
params["states"].append(["S1",[14,15,-15,16,-16,-17]])  # index 1   H-2->L
params["states"].append(["S2",[14,15,-15,16,-16,-18]])  # index 2   H-2->L+1
params["states"].append(["S3",[14,-14,15,16,-16,-17]])  # index 3   H-1->L
params["states"].append(["S4",[14,-14,15,16,-16,-18]])  # index 4   H-1->L+1
params["states"].append(["S5",[14,-14,15,-15,16,-17]])  # index 5   H  ->L
params["states"].append(["S6",[14,-14,15,-15,16,-18]])  # index 6   H  ->L+1
params["states"].append(["S7",[14,15,-15,16,-16,-19]])  # index 7   H-2->L+1
params["states"].append(["S8",[14,15,-15,16,-16,-20]])  # index 8   H-2->L+2
params["states"].append(["S9",[14,15,-15,16,-16,-21]])  # index 9   H-2->L+3
params["states"].append(["S10",[14,15,-15,16,-16,-22]]) # index 10  H-2->L+4
params["states"].append(["S11",[14,-14,15,16,-16,-19]]) # index 11  H-1->L+1
params["states"].append(["S12",[14,-14,15,16,-16,-20]]) # index 12  H-1->L+2
params["states"].append(["S13",[14,-14,15,16,-16,-21]]) # index 13  H-1->L+3
params["states"].append(["S14",[14,-14,15,16,-16,-22]]) # index 14  H-1->L+4
params["states"].append(["S15",[14,-14,15,-15,16,-19]]) # index 15  H  ->L+1
params["states"].append(["S16",[14,-14,15,-15,16,-20]]) # index 16  H  ->L+2
params["states"].append(["S17",[14,-14,15,-15,16,-21]]) # index 17  H  ->L+3
params["states"].append(["S18",[14,-14,15,-15,16,-22]]) # index 18  H  ->L+4


#Among above mutli-electron states, state S7 an S8 are the ones we will plot their populations
